...
The result of ***doEnrich*** is *demo_result* which contains *enrich, interestGenes, test, method, m, maxGsize, minGsize, delta, traditional, penalize*. 
...
The data frame *doterms* contains the information of the disease ontology for DAG construction. You can use showDoTerms to see the details.
